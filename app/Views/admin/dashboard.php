...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 fs-4 fw-bold text-uppercase border-bottom text-white">
                <i class="fas fa-user-secret me-2"></i>Ujian App
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light py-4 px-4">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        <button class="btn btn-danger rounded-pill p-1">
                            <div class="p-1">
                                <i class="fas fa-sign-out-alt me-2"></i><span class="fs-10">Logout</span> 
                            </div>
                        </button>
                    </li>
                </ul>
